...
If you’re using React Router 0.13, you might [bump into this problem](https://github.com/jnields/vue-redux/issues/43). The solution is simple: whenever you use `<RouteHandler>` or the `Handler` provided by `Router.run`, pass the router state to it.
